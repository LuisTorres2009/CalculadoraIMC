...
O usuário digita seu peso e altura → Pressiona o botão de cálculo → O app calcula o IMC, classifica o IMC e calcula o intervalo de peso ideal → Exibe tudo isso na tela de forma amigável e clara. 
